...
class Migration4to5Test {
    ...
    private fun openRoomDb(): AppDatabase =
        Room.databaseBuilder(context, AppDatabase::class.java, dbName)
            ...
            // no-op 5→6 step and additive history-preserving 6→7 step.
    ...
    fun `v4 database without explicit migration is not silently destroyed`() = runTest {
        ...
        assertTrue("opening a v4 file at the current version without migration must fail, not destroy", threw)
