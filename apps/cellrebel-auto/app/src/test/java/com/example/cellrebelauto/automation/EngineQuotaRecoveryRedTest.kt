...
class EngineQuotaRecoveryRedTest {
    ...
    // ====================================================================================
    // P1-1 (Sol closure review R2): missing task/anchor fail-closed guards.
    //
    // A missing task is always an invariant break. A missing anchor at QUOTA_COMMITTED
    // (where the lifecycle MUST have persisted it) is also an invariant break. For
    // DECIDING crashes where the trusted entry survived the crash window, anchor=null
    // is legitimate (advance never started) — that case is covered by M-CR-07.
    //
    // # P1-1：task 丢失恒 invariant break；anchor 丢失在 QUOTA_COMMITTED 下 invariant break
    // ====================================================================================
