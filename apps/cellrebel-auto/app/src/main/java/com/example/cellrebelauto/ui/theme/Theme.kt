...
/**
 * T7v2 视觉体系 — shadcn/ui 的中性极简体系翻译成 M3 自定义 ColorScheme
 * （UI-HIFI-BRIEF-V2.md 的 tokens 段）。抛弃 M3 默认紫：主色是近黑（light）/
 * 近白（dark），tonal 容器一律压成中性灰，卡片 = 1px 边框 + 12dp 圆角 + 无阴影。
 *
 * 语义色（徽标/状态点）不在 M3 ColorScheme 里，走 [LocalShadcnSemantic]：
 * 绿=完成/健康、蓝=进行中、灰=待完成、amber=注意、红=失败。
 */
...
/** 徽标/状态点的语义色（绿/蓝/灰/amber/红），亮暗各一组。 */
