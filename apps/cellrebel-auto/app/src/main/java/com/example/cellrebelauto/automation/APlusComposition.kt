...
object APlusComposition {
    ...
    fun productionBackend(
        ...
        require(
            rawExecutor !is com.example.cellrebelauto.recovery.BinderExternalApplyExecutor ||
                rawExecutor.targetApplicationId == providerApplicationId
        ) {
            "Provider principal mismatch: trust=$providerApplicationId " +
                "binder=${(rawExecutor as com.example.cellrebelauto.recovery.BinderExternalApplyExecutor).targetApplicationId}"
        }
