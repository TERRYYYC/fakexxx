...
| F-19 | Auto 启动闪退：Room v5 schema 漂移无迁移路径（operator 裁 B：v6 + 漂移隔离区 + destructive fallback，INV-24 范围内豁免） | review | fable-5 → glm52 review / codex-terra 监督 | [docs/features/2026-08-27-f19-auto-room-v5-drift-quarantine-rebuild.md](docs/features/2026-08-27-f19-auto-room-v5-drift-quarantine-rebuild.md) |
